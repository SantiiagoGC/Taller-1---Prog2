...
public class Biblioteca {
	 ...
	 */
	public String crearPrestamo(int fechaPrestamo, String titulo, String codigo, String codigoPrestamo, int fechaDevolucion, Estudiante estudiante, Bibliotecario bibliotecario) {
		...
		double costoPrestamo2;
			...
			if(prestamo1 == null) {
				if(libro1!= null) {
					...
					if(libro1.getTitulo().equals(titulo) && libro1.getCodigo().equals(codigo)) {
						prestamo1 = new Prestamo(fechaPrestamo, titulo, codigo, codigoPrestamo, fechaDevolucion, estudiante1,  bibliotecario1);
			...
			if(prestamo2 == null) {
				if(libro1!= null) {
					...
					if(libro1.getTitulo().equals(titulo) && libro1.getCodigo().equals(codigo)) {
						   prestamo2= new Prestamo(fechaPrestamo, titulo, codigo, codigoPrestamo, fechaDevolucion, estudiante2,  bibliotecario2);
						   cantidad1 = libro1.getCantidadDisponible()-1;
